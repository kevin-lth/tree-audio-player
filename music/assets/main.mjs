...
const known_assets = {
    ...
    'home.svg': { url: "svg/home.svg", mime_type: "image/svg+xml", etag: "01" },
    'person.svg': { url: "svg/person.svg", mime_type: "image/svg+xml", etag: "01" },
    'lock.svg': { url: "svg/lock.svg", mime_type: "image/svg+xml", etag: "01" },
    'cog.svg': { url: "svg/cog.svg", mime_type: "image/svg+xml", etag: "01" },
